...
import 'umrohnew.dart';

class IntroUmroh extends StatefulWidget {
  const IntroUmroh({super.key});
                          ...
                          Column(
                            ...
                            children: [
                              ...
                              const Padding(
                                ...
                                child: Text(
                                  'Berjalan kaki dan berlari-lari kecil di antara kedua bukit Shafa dan Marwah, sebanyak 7 kali (bolak-balik) dari Bukit Shafa ke Bukit Marwah dan sebaliknya',
                                  textAlign: TextAlign.center,
                                  style: TextStyle(
                                    fontSize: 18.0,
                                    fontWeight: FontWeight.w300,
                              ...
                              child: const Padding(
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    ...
                                    SizedBox(width: 5),
                                    Icon(Icons.skip_next, color: Colors.green),
                                  ],
                                ),
                              ),
                            ),
